	...
	render() {
		return (
			<React.Fragment>
				...
				<div className="ui segment raised" style={{ marginTop: '2.5em', marginBottom:0, paddingTop: '10vh', paddingBottom: '10vh', background: "url('/static/beautiful-restaurant-websites.jpg') #FAFAFA center right", backgroundSize: 'auto 100%', backgroundRepeat: 'no-repeat' }}>
				...
				<div style={{ backgroundColor: 'aliceblue' }}>
					{
						this.state.loaded ?
							<div className="ui container">
								<br/>
								<div class="ui vertical animated button raised" style={{float: 'right'}} onClick={e=>{
										e.preventDefault()
										location.reload()
									}}>
													...
													<div className="content">
														...
														<div className="description">
															<div className="ui three column grid">
																...
																{
																	h['Top Ten'] != 'NaN' ? <div className="six wide column">
